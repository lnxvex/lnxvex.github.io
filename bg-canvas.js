...
(function () {
  ...
  function frame(time) {
    ...
    drawBlob(x1, y1, r1, [
      [0, "rgba(51, 230, 255, 0.34)"],
      [0.45, "rgba(51, 230, 255, 0.11)"],
      [1, "rgba(5, 7, 15, 0)"]
    ]);
    ...
    drawBlob(x2, y2, r2, [
      [0, "rgba(57, 255, 136, 0.22)"],
      [0.5, "rgba(57, 255, 136, 0.08)"],
      [1, "rgba(5, 7, 15, 0)"]
    ]);
    ...
    drawBlob(x3, y3, r3, [
      [0, "rgba(167, 139, 250, 0.22)"],
      [0.55, "rgba(167, 139, 250, 0.07)"],
      [1, "rgba(5, 7, 15, 0)"]
    ]);
  ...
  function drawStatic() {
    ...
    drawBlob(w * 0.3, h * 0.25, Math.max(w, h) * 0.45, [
      [0, "rgba(51, 230, 255, 0.18)"],
      [1, "rgba(5, 7, 15, 0)"]
    ]);
    drawBlob(w * 0.75, h * 0.6, Math.max(w, h) * 0.4, [
      [0, "rgba(57, 255, 136, 0.14)"],
      [1, "rgba(5, 7, 15, 0)"]
    ]);
  }
